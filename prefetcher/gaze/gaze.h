...
struct gaze : public champsim::modules::prefetcher {
  ...
  explicit gaze(CACHE* cache) :
      prefetcher(cache),
      impl(gaze_impl::FT_SIZE, gaze_impl::FT_WAY, gaze_impl::AT_SIZE, gaze_impl::AT_WAY,
           gaze_impl::PT_SIZE, gaze_impl::PT_WAY, gaze_impl::PB_SIZE, gaze_impl::PB_WAY,
           cache->cpu) {}
