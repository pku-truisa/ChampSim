//=======================================================================================//
// File             : moPythia/moPythia_params.h
// Author           : Based on Pythia (Bera+, MICRO'21)
// Date             : 03/AUG/2026
// Description      : Defines all parameters of moPythia - Memory Object aware Pythia
//=======================================================================================//

#ifndef __MO_PYTHIA_PARAMS_H__
#define __MO_PYTHIA_PARAMS_H__
...
//------------------------------------//
// Active features (restored to original Pythia + PC_Path):
//   0  = F_PC               (pc)
//   7  = F_PC_Path          (pc path signature)
//   10 = F_PC_Delta         (pc + delta)
static const std::vector<int32_t> le_featurewise_active_features = {0, 7, 10};
