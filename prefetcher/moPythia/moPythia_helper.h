//=======================================================================================//
// File             : moPythia/moPythia_helper.h
// Author           : Based on Pythia (Bera+, MICRO'21)
// Date             : 03/AUG/2026
// Description      : Implements helper functionalities for moPythia - Memory Object aware Pythia
//=======================================================================================//

#ifndef __MO_PYTHIA_HELPER_H__
#define __MO_PYTHIA_HELPER_H__
...
typedef struct _stats {
  ...
  struct {
    ...
    uint64_t action_dist[MO_PYTHIA::max_actions];
    uint64_t issue_dist[MO_PYTHIA::max_actions];
    uint64_t pred_hit[MO_PYTHIA::max_actions];
    uint64_t out_of_bounds_dist[MO_PYTHIA::max_actions];
    uint64_t predicted;
    uint64_t multi_deg;
    uint64_t multi_deg_called;
    uint64_t multi_deg_histogram[MO_PYTHIA::max_degree + 1];
    uint64_t deg_histogram[MO_PYTHIA::max_degree + 1];
  } predict;
  ...
  struct {
    ...
    struct {
      uint64_t dist[MO_PYTHIA::max_rewards][2];
    } compute_reward;
    ...
    uint64_t dist[MO_PYTHIA::max_actions][MO_PYTHIA::max_rewards];
  } reward;
  ...
  struct {
    uint64_t epochs;
    uint64_t histogram[MO_PYTHIA::max_dram_bw_levels];
  } bandwidth;
} PythiaStats;

} // namespace mop

#endif /* __MO_PYTHIA_HELPER_H__ */