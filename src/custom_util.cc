...
uint32_t custom_util::HashZoo::murmur3(uint32_t key) {
    /* murmur3 32-bit finalization steps */
    key ^= key >> 16;
    key *= 0x85ebca6b;
    key ^= key >> 13;
    key *= 0xc2b2ae35;
...
/*                                   Pythia                                   */
/******************************************************************************/
std::string custom_util::BitmapHelper::to_string(custom_util::PythiaBitmap bmp, uint32_t size) {
...
uint32_t custom_util::BitmapHelper::count_bits_set(custom_util::PythiaBitmap bmp, uint32_t size) {
...
uint32_t custom_util::BitmapHelper::count_bits_same(custom_util::PythiaBitmap bmp1, custom_util::PythiaBitmap bmp2, uint32_t size) {
...
uint32_t custom_util::BitmapHelper::count_bits_diff(custom_util::PythiaBitmap bmp1, custom_util::PythiaBitmap bmp2, uint32_t size) {
...
uint64_t custom_util::BitmapHelper::value(custom_util::PythiaBitmap bmp, uint32_t /*size*/) {
    return bmp.to_ullong();
}

custom_util::PythiaBitmap custom_util::BitmapHelper::rotate_left(custom_util::PythiaBitmap bmp, uint32_t amount, uint32_t size) {
    custom_util::PythiaBitmap result;
...
custom_util::PythiaBitmap custom_util::BitmapHelper::rotate_right(custom_util::PythiaBitmap bmp, uint32_t amount, uint32_t size) {
    custom_util::PythiaBitmap result;
    for (uint32_t index = 0; index < size - amount; ++index) {
...
custom_util::PythiaBitmap custom_util::BitmapHelper::compress(custom_util::PythiaBitmap bmp, uint32_t granularity, uint32_t size) {
...
custom_util::PythiaBitmap custom_util::BitmapHelper::decompress(custom_util::PythiaBitmap bmp, uint32_t granularity, uint32_t size) {
    custom_util::PythiaBitmap result;
    result.reset();
...
custom_util::PythiaBitmap custom_util::BitmapHelper::bitwise_or(custom_util::PythiaBitmap bmp1, custom_util::PythiaBitmap bmp2, uint32_t size) {
    custom_util::PythiaBitmap result;
    for (uint32_t index = 0; index < size; ++index) {
        if (bmp1[index] || bmp2[index]) {
            result[index] = true;
...
custom_util::PythiaBitmap custom_util::BitmapHelper::bitwise_and(custom_util::PythiaBitmap bmp1, custom_util::PythiaBitmap bmp2, uint32_t size) {
    custom_util::PythiaBitmap result;
    for (uint32_t index = 0; index < size; ++index) {
        if (bmp1[index] && bmp2[index]) {
            result[index] = true;
