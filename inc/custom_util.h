...
typedef std::bitset<BITMAP_MAX_SIZE> PythiaBitmap;

class BitmapHelper {
public:
    static uint64_t value(PythiaBitmap bmp, uint32_t size = BITMAP_MAX_SIZE);
    static std::string to_string(PythiaBitmap bmp, uint32_t size = BITMAP_MAX_SIZE);
    static uint32_t count_bits_set(PythiaBitmap bmp, uint32_t size = BITMAP_MAX_SIZE);
    static uint32_t count_bits_same(PythiaBitmap bmp1, PythiaBitmap bmp2, uint32_t size = BITMAP_MAX_SIZE);
    static uint32_t count_bits_diff(PythiaBitmap bmp1, PythiaBitmap bmp2, uint32_t size = BITMAP_MAX_SIZE);
    static PythiaBitmap rotate_left(PythiaBitmap bmp, uint32_t amount, uint32_t size = BITMAP_MAX_SIZE);
    static PythiaBitmap rotate_right(PythiaBitmap bmp, uint32_t amount, uint32_t size = BITMAP_MAX_SIZE);
    static PythiaBitmap compress(PythiaBitmap bmp, uint32_t granularity, uint32_t size = BITMAP_MAX_SIZE);
    static PythiaBitmap decompress(PythiaBitmap bmp, uint32_t granularity, uint32_t size = BITMAP_MAX_SIZE);
    static PythiaBitmap bitwise_or(PythiaBitmap bmp1, PythiaBitmap bmp2, uint32_t size = BITMAP_MAX_SIZE);
    static PythiaBitmap bitwise_and(PythiaBitmap bmp1, PythiaBitmap bmp2, uint32_t size = BITMAP_MAX_SIZE);
};
