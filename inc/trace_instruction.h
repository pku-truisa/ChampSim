...
//      2 = free        — source_memory[0]: pointer to free
//      3 = mmap        — source_memory[0]: length,
//                         destination_memory[0]: mapped addr
//      4 = munmap      — source_memory[0]: addr,
//                         source_memory[1]: length
//      5 = calloc      — source_memory[0]: total_size (nmemb x elem_size),
//                         destination_memory[0]: allocated addr
//      6 = realloc     — source_memory[0]: old_ptr,
//                         source_memory[1]: new_size,
//                         destination_memory[0]: new_ptr
//      8 = posix_memalign — source_memory[0]: size,
//                            source_memory[1]: alignment,
//                            destination_memory[0]: allocated addr
//     16 = realloc_inplace — source_memory[0]: ptr (unchanged),
//                             destination_memory[0]: same ptr
// ==========================================================================
